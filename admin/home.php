        ...
        <nav class="navbar-default navbar-side" role="navigation">
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li>
						<a class="active-menu" href="roombook.php"><i class="fa fa-bar-chart-o"></i> Đặt phòng</a>
					</li>
					<li>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    $sql = "DELETE FROM roombook WHERE ";
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse">
                                            <div class="panel-body">
												...
												<th>" . $crow['approval'] . "</th>
                                                        ...
                                                        <a href="messages.php" class="btn btn-primary">Các hoạt động khác</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
